...
///来料检验单列表
class ArrivalTestOrderSampleListPage extends StatefulWidget {
  @override
  ArrivalTestOrderSampleListPageState createState() =>
      new ArrivalTestOrderSampleListPageState();
}

class ArrivalTestOrderSampleListPageState
    extends ListCommonState<ArrivalTestOrderSampleListPage> {
  @override
  void initState() {
    super.initState();
  }
  ...
  @protected
  void initParams() {
    params.docCat = Config.test_order_arrival_sample;
    ...
    switch (field) {
      ...
      case 'docNo':
        NavigatorUtil.goToPage(
            ...
            permissions: UserPermissionsConfig.arrivalSample_view,
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: new AppBarWidget(
        title: StringZh.arrivalTestOrderSampleList_title,
      ),
      body: new Column(
        children: <Widget>[
