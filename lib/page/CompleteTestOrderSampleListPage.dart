...
///完工检验单(按样本)列表
class CompleteTestOrderSampleListPage extends StatefulWidget {
  @override
  CompleteTestOrderSampleListPageState createState() =>
      new CompleteTestOrderSampleListPageState();
}

class CompleteTestOrderSampleListPageState
    extends ListCommonState<CompleteTestOrderSampleListPage> {
  @override
  void initState() {
    super.initState();
  }
  ...
  @protected
  void initParams() {
    params.docCat = Config.test_order_complete_sample;
    ...
    switch (field) {
      ...
      case 'docNo':
        NavigatorUtil.goToPage(
            ...
            permissions: UserPermissionsConfig.completeSample_view,
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: new AppBarWidget(
        title: StringZh.completeTestOrderSampleList_title,
      ),
      body: new Column(
        children: <Widget>[
