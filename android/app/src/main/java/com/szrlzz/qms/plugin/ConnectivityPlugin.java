...
public class ConnectivityPlugin implements MethodCallHandler, StreamHandler {
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel =
        new MethodChannel(registrar.messenger(), "com.szrlzz.qms/connectivity");
    final EventChannel eventChannel =
        new EventChannel(registrar.messenger(), "com.szrlzz.qms/connectivity_status");
  ...
  private void handleBSSID(MethodCall call, Result result) {
    WifiInfo wifiInfo = getWifiInfo();
    String bssid = null;
